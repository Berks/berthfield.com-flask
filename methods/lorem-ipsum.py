...
for i in range(10):
    Post.create(
        head_img="/static/assets/img/post-bg.jpg",
        title="Man must explore, and this is exploration at its greatest",
        sub="Problems look mighty small from 150 miles up",
        body={"Never in all their history have men been able truly to conceive of the world as one: a single sphere,"
              " a globe, having the qualities of a globe, a round earth in which all the directions eventually meet,"
              " in which there is no center because every point, or none, is center — an equal earth which all men occupy"
              " as equals. "
              ...
              " back from science. "
              " The early warnings about technological dangers also come from science."
        ...
        img="/static/assets/img/post-sample-image.jpg",
    )
